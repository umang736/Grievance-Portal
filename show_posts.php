...
.show{color:#FFF;font-family:Verdana, Geneva, sans-serif;
border:solid black;
...
.reply{font-family:Verdana, Geneva, sans-serif; color:#FF0; 
border:ridge #F06;
border-radius:40px;
padding:10px;
background:linear-gradient(blue,white);}
...
.gayab{position:relative;left:-96px; top:-45px;}
.gayab3{position:relative;left:+372px; top:22px;}
.gayab4{position:relative;left:+360px; top:38px;}
...
echo "<script>
		setTimeout(function(){window.location.href='show_posts.php'},3000);</script>";
			//die();
}
...
echo "</td></tr></table>";
	...
	$text=$result['reply'];
$sub='sub'.$i;
	echo "<input class=\"spi\" type=\"submit\" value=\"submit\" onclick=\"process('$text','$submit','$id','$response')\" id=\"$sub\">";	
	echo "</div>";
	...
	{
		echo "<br /><a href=\"show_posts.php?no=$new\">"."<h4 align=\"right\" style=\"color:
